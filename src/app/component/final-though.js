  ...
  return (
      ...
      <div  style={{
            backgroundImage: 'url("/images/Frame 155.png")',
                ...
                <div className="max-w-[1240px] mx-auto xl:px-0 px-[16px] md:flex justify-between ">
                    <div className="sm:hidden block  sm:pt-0 pb-[10px]">
                        <Image src={work1} alt='' />
                    </div>
                    <div className="sm:max-w-[542px] ">
                        <div className="">
                            <span className='text-[#FFFF00] text-[23px] font-[400] '>Let’s Build the Future, Together.</span>
                            <h1 className='text-[#F6F6F6] sm:text-[60px] text-[40px] font-[400]'>Final Thoughts</h1>
                        </div>
    ...
    if (section) {
      section.scrollIntoView({ behavior: "smooth" });
                    ...
                    <div className="sm:block hidden md:pt-0 pt-[50px]">
                        <Image src={work1} alt='' />
                    </div>
                </div>
            </div>
