    ...
    >
      <div className="max-w-[1240px] mx-auto py-[48px] md:py-[80px] xl:px-0 px-[16px]">
        ...
        <div className="pt-[48px] ">
          <div data-aos="slide-up" data-aos-duration="8000" className="p-6 lg:flex cursor-pointer items-center justify-between bg-gradient-to-r from-[#43430D] to-[#464646] origin-left border-[#9F9F00] border-[1px] rounded-[10px]">
          ...
          <div data-aos="slide-up" data-aos-duration="8000" className=" my-[20px] cursor-pointer p-6 lg:flex  items-center justify-between bg-gradient-to-r from-[#43430D] to-[#464646] origin-left border-[#9F9F00] border-[1px] rounded-[10px]">
            <h5 className="lg:text-[23px] text-[25px] text-[#F6F6F6]">
          ...
          <div data-aos="slide-up" data-aos-duration="8000" className="p-6 lg:flex  items-center justify-between bg-gradient-to-r from-[#43430D] to-[#464646] origin-left border-[#9F9F00] border-[1px] rounded-[10px]">
            <h5 className="lg:text-[23px] text-[25px] text-[#F6F6F6]">
